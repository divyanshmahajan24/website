  ...
  const header = (
    <div className="header">
      <div className="social">
        {(!isRootPath) && <Link to="/" className="back-home" itemProp="url">←</Link>}
        <a href="https://twitter.com/divyanshmhjn" target="_blank">
        ...
        <a href="https://github.com/divyanshmahajan24" target="_blank">
          <svg width="32" height="32" viewBox="0 0 800 800">
      ...
      <div className="nav">
        <a href="" className="nav-list-item">BLOG</a>
